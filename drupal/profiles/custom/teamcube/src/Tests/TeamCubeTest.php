...
/**
 * @file
 * Contains \Drupal\teamcube\Tests\TeamCubeTest.
 */

namespace Drupal\teamcube\Tests;
...
/**
 * Tests Team Cube installation profile expectations.
 *
 * @group custom
 */
class TeamCubeTest extends WebTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'teamcube';
  ...
  /**
   * Tests Team Cube installation profile.
   */
  function testTeamCube() {
    $this->drupalGet('');
    ...
    // Team Cube profile modules are enabled.
    ...
    // Ensure that configuration from the Team Cube profile is not reused when
